...
const NavigationCircles = ({ section }) => {
  return (
    <div className='h-[300px] w-[1px] bg-red-500 dark:bg-yellow-500 absolute right-12 hidden
    md:flex flex-col justify-between items-center transition-colors duration-500 '>
